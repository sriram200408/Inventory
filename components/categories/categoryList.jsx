...
import productsData from "../../categoriesdb.json";
import axios from "axios";

export default function CategoryLists() {
  const [products, setProducts] = useState(productsData.Categories);
  const [selectedProducts, setSelectedProducts] = useState({});
  const [selectAll, setSelectAll] = useState(false);
  const [sortedProducts, setSortedProducts] = useState(productsData.Categories);
  ...
  function updateData(updatedProduct) {
    axios
      .patch(
        `http://localhost:3032/Categories/${updatedProduct.id}`,
        updatedProduct
      )
      .then((response) => {
  ...
  function deleteData(id) {
    axios
      .delete(`http://localhost:3032/Categories/${id}`)
      .then(() => {
      ...
      <div>
        ...
        <div className="mb-4 flex justify-between">
          ...
          <span>
            ...
            of {filteredProducts.length} Categories
          </span>
        </div>
        <Table>
            ...
            <div className="bg-white p-4 rounded">
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditProduct({ ...editProduct, variant: e.target.value })
                  }
                  className="mb-2 p-2 border border-gray-300 rounded"
                />
